...
/* Add in craco.config.js or webpack config file
...
module.exports.getVendorDir = function() {
  ...
  */
  ...
  if (process.versions.hasOwnProperty('electron') && process.env.NODE_ENV != 'development') {
    dirName = path.join(process.resourcesPath, 'app.asar.unpacked/node_modules/electron-node-notifier/lib');
  }
